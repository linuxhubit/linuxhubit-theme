...
<div class="uk-container uk-articles">
    ...
    <article class="uk-article">
        ...
        <div class="uk-margin"><?= substr(strip_tags ($post->excerpt), 0, 200) ?: substr(strip_tags ($post->content), 0, 200) ?>…</div>

        <div class="uk-margin-large-top">
            <ul class="uk-subnav uk-margin-bottom-remove">

                <li><a href="<?= $view->url('@blog/id', ['id' => $post->id]) ?>"><?= __('Read more') ?><i class="uk-icon-arrow-right"></i></a></li>
